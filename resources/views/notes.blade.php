...
<body>
                ...
                <table class="table">
                    ...
                    @foreach($notes as $note)
                        <tr>
                            ...
                            <td><input type="text" id="titleUpdate{{$note->id}}" value="{{$note->title}}"></td>
                            <td><input type="text" id="contentUpdate{{$note->id}}" value="{{$note->content}}"></td>
    ...
    <div class="alert" role="alert" id="alert">
        Explore this primary alert message!
    </div>
</body>
</html>
